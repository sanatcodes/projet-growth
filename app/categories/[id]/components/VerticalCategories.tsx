...
export default async function verticalCategories() {
  ...
  return (
    <div className="flex flex-col justify-center items-center mt-6 p-5">
      ...
      {categories.map((category: APIResponse) => (
        ...
        >
          <button className=" flex flex-col items-center justify-content py-2 pl-4 pr-2 text-left text-black hover:text-gray-300 focus:outline-none focus:text-gray-900 w-full">
